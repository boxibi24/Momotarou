...
class Node(BaseNode):
    ...
    node_label = 'Set String Array'
    node_type = NodeTypeFlag.SetVariable
    pin_dict = {
        'String Array in': InputPinType.StringArray,
        'String Array out': OutputPinType.StringArray
    }
    ...
    def run(internal_data_dict):
        ...
        if var_value is None:
            ...
            internal_data_dict['var_value'][0] = internal_data_dict['String Array in']
            internal_data_dict['String Array out'] = internal_data_dict['String Array in']
